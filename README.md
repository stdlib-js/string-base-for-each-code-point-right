...
```javascript
forEachCodePointRight = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/string-base-for-each-code-point-right@v0.0.2-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/string-base-for-each-code-point-right/actions/workflows/test.yml/badge.svg?branch=v0.0.2
[test-url]: https://github.com/stdlib-js/string-base-for-each-code-point-right/actions/workflows/test.yml?query=branch:v0.0.2
